        ...
        <Row>
          <Col>
            <div className="px-3 mt-2 py-1 SSA_DASHBOARD_border">
              <p className=" text-[18px]" style={{color:colors.grey[300]}}>
        ...
        <Row className="py-5 mb-4 d-flex align-items-center ">
          ...
          <Col md={3}>
            <div className=" p-4 mt-3 ab-height mx-auto ">
              <p className=" text-[18px] text-left mt-3" style={{color:colors.grey[300]}}>
        ...
        <Row className="d-flex py-5 text-center justify-content-center align-items-center">
          ...
          <div className="d-flex justify-content-center">
            <h5
              ...
              style={{ fontWeight: "700", color:colors.grey[300] }}
            >
            ...
            <div class="sana-welcome-card">
              <div class="sana-welcome-card-details">
                <div class="d-flex justify-content-center align-items-start mb-2">
                  <img
                    src="https://imagedelivery.net/f5tF3V4WaB6L98qcq1rX5w/fc04aeda-faad-4f2c-44d1-cd0297291000/public"
                    alt=""
                  />
                </div>
                <h4 style={{ fontWeight: "800" ,color:colors.grey[300]}}>Step 1</h4>
                <h5 style={{ fontWeight: "800", fontSize: "1.15rem",color:colors.grey[300] }}>
                  Choose payment method and top up your balance
                </h5>
                <p class="sana-welcome-text-body" style={{color:colors.grey[300]}}>
          ...
          <Col className="text-center py-2 px-0 mx-1 justify-content-center">
          ...
          <Col>
            <div class="sana-welcome-card">
              <div class="sana-welcome-card-details">
                ...
                <h4 style={{ fontWeight: "800",color:colors.grey[300] }}>Step 2</h4>

                <h5 style={{ fontWeight: "800", fontSize: "1.15rem" ,color:colors.grey[300]}} >
                  Create a campaign <br />
                  Choose payment method and top up your balance.
                </h5>
                <p class="sana-welcome-text-body mb-3" style={{color:colors.grey[300]}}>
          ...
          <Col>
            <div class="sana-welcome-card">
              <div class="sana-welcome-card-details">
                ...
                <h4 style={{ fontWeight: "800" ,color:colors.grey[300]}}>Step 3</h4>
