    ...
    <div className="container px-5 py-5 my-5">
      ...
      <Slider {...settings}>
        ...
        <div className="px-1">
          <label className="sana-label">
            <input type="checkbox" />
            <FlipCard title={"Interstial Ads"} imgSrc={"https://assets-global.website-files.com/614b3e8cafbd9789234c277e/64f8a2c21096201030ac1700_Facebook%20advertising.jpg"} />
            <FlipCard title={"Banner Ads"} imgSrc={"https://assets-global.website-files.com/614b3e8cafbd9789234c277e/64f8a2c21096201030ac1700_Facebook%20advertising.jpg"} />
          </label>
        </div>
      </Slider>
    </div>
