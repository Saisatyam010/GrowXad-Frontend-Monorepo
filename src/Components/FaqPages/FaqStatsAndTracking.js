...
import './FaqStatsAndTracking.css'
import { Container, Row, Col, Accordion } from 'react-bootstrap';
import { FaChevronRight } from "react-icons/fa6";
import Layout from '../Layout/Layout';


export const FaqStatsAndTracking = () => {
    return (
        <Layout>
                        ...
                        <Row>
                            ...
                            <Col md={12}>
                                <div className='d-flex pt-4 fs-4'>
                                    ...
                                    <span className='dp_campaign_guide_sub_items'>Stats and Tracking</span>
                                </div>

                                <h3 className='fw-bold pt-3'>Stats and Tracking</h3>
                            </Col>
