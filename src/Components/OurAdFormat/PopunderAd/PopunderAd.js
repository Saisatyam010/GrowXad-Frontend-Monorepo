...
const PopunderAd = () => {
  ...
  const SelfServePlatform = [
    ...
    },
    {
      num: "3",
      content:
        "Enter your domain and fill out all the fields required. Pick one of the Popunder sizes. Click SUBMIT.",
    },
    {
      num: "4",
      content:
    ...
    },
    {
      num: "5",
      content:
        "Per our instructions, place the Popunder's code on your web page. Get instructions.",
    },
  ];
  ...
  return (
    <div className=" px-2 ">
        ...
        <div className="row" style={{ marginTop: "70px" }}>
          <div className="col-md-6">
            <h1 className="SSA_DisplayBanner_font-3rem">
              {" "}
              <span className="SSA_DisplayBanner_VoiletText">Popunder Ad</span> —
              Implement Popunder Ads on Your Site
            </h1>
            <p className="SSA_DisplayBanner_font-18px pb-3 ">
              {" "}
              Unlock peak performance for publishers with online Popunder ads.
              Webmasters and bloggers experience 100% fill rates and lucrative
              payouts. Advertisers tap into dependable traffic sources,
              connecting with informed customers poised for purchase. For
              optimal results, choose the impact of an online Popunder ad.
            </p>
            <Link to="/adveriserauthLogin" className='no-underline hover:no-underline'>
              <button className="border-anim-btn">GET POPUNDER CODE</button>
            </Link>
          </div>
          <div className="col-md-6 pt-4 px-3 px-md-0 px-lg-0 pt-md-0 pt-lg-0">
            <div className="d-flex justify-content-center">
              <img
                src="https://imagedelivery.net/f5tF3V4WaB6L98qcq1rX5w/8fd9a937-13f1-48cf-7e63-ac13c8cd8300/public"
                alt=""
                className="mx-0"
              />
            </div>
        ...
        <div className="container py-5">
          <div className="row">
            <div className="SSA_DisplayBanner_font-34px text-center">
              GrowX benefits both publishers and advertisers with effective
              solutions.
            </div>
              ...
              <div className="SSA_Solution_New_Cards_Box ">
                <div class="SSA_Solution_Cards p-5 ">
                  ...
                  <p className="SSA_BannerDisplay_Card_desc SSA_DisplayBanner_font-18px">
                    Effortlessly integrate online Popunder ads on any website,
                    including WordPress and BlogSpot (Blogger), and more.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6 pt-4">
              <div className="SSA_Solution_New_Cards_Box ">
                <div class="SSA_Solution_Cards p-5">
                  ...
                  <p className="SSA_BannerDisplay_Card_desc SSA_DisplayBanner_font-18px">
                    Popunder ads effortlessly operate on all operating systems,
                    ensuring broad compatibility for optimal reach and
                    engagement.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-6 pt-4">
              <div className="SSA_Solution_New_Cards_Box ">
                <div class="SSA_Solution_Cards p-5">
                  ...
                  <p className="SSA_BannerDisplay_Card_desc SSA_DisplayBanner_font-18px">
                    Unlock top-tier earnings with popunder ads powered by proven
                    advertisers delivering high CPMs.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6 pt-4">
              <div className="SSA_Solution_New_Cards_Box ">
                <div class="SSA_Solution_Cards p-5">
                  ...
                  <p className="SSA_BannerDisplay_Card_desc SSA_DisplayBanner_font-18px">
                    Experience a popunder ad solution with consistent and robust
                    fill rates, ensuring maximum exposure and revenue for your
                    content.
                  </p>
                </div>
              </div>
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <p className="SSA_DisplayBanner_font-18px pb-3 ">
              ...
              Traditional yet effective, Popunder advertising stand
              as the time-tested pillars of online promotion, with proven
              efficiency. Popunder, whether images or GIFs, find placement on
              publishers' websites, mobile sites, and blogs. IAB identifies
              standard and highly clickable Popunder ad formats for both desktop
              and mobile devices.
            </p>
            <Link to="/adveriserauthLogin" className='no-underline hover:no-underline'>
          ...
          <div className="col-md-6 pt-md-0 pt-lg-0 pt-3">
            <div className="d-flex justify-content-center">
              <img
                src="https://imagedelivery.net/f5tF3V4WaB6L98qcq1rX5w/06a680a5-af7f-491b-0bc8-48764204d400/public"
                alt=""
                className="mx-0"
              />
            </div>
      ...
      <div className="container py-md-5 py-2 py-lg-5 my-5">
        <div className="row">
          <div className="col-md-6">
            <h1 className="SSA_DisplayBanner_font-3rem">
              {" "}
              What are Popunder ads good for?
            </h1>
            {BannerAdsGoodReasons.map((item, index) => {
              return (
                <div className="text-left text-start sana-text">
            ...
            <div className="col-md-6 pr-md-5 pr-lg-5 pr-0">
              <div className="pr-5">
                <h1 className="SSA_DisplayBanner_font-34px pb-3">
                  {" "}
                  How to put Popunder on a website?
                </h1>
                <p className="SSA_DisplayBanner_font-18px pb-3 ">
                  Employ Popunder strategically across your webpage—header,
      ...
      <div className="container py-md-5 py-lg-5 py-0 my-md-5 my-lg-5 my-3">
        <div className="row align-items-center">
          <div className="col-md-7">
            <h1 className="SSA_DisplayBanner_font-34px pb-3">
              {" "}
              HOW TO GET A POPUNDER CODE in minutes with GrowX Self-Serve Platform{" "}
            </h1>
      ...
      <div style={{ backgroundColor: "#e9e9e9" }}>
        <div className="SSA_DisplayBanner_font-34px py-3  text-center">
