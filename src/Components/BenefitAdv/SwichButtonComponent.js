                ...
                <div className='px-md-5 px-0'>
                    <div class="row mx-md-5 mx-0 justify-content-center" style={{ padding: '0px !important', margin: '0px !important', border: '1px solid black', borderRadius: '28px' }}>
                        ...
                        <div className="col-4 text-center" onClick={() => {
                            ...
                            style={{ cursor: 'pointer', backgroundColor: socialBar ? 'black' : 'white', color: socialBar ? 'white' : 'black', borderRadius: '28px', borderBottomRightRadius: '28px' }}
                        >
                            <div className='py-3' style={{}}>
                                <div>Native Ads</div>
                            </div>
                        ...
                        <div className="col-4 text-center" onClick={() => {
                            ...
                            style={{ cursor: 'pointer', backgroundColor: inPagePush ? 'black' : 'white', color: inPagePush ? 'white' : 'black', borderRadius: '28px', borderBottomRightRadius: '28px' }}
                        >
                            <div className='py-3' style={{}}>
                    ...
                    {popunder && <><div className="container mt-4 p-5" style={{ backgroundColor: '#efefef', borderRadius: '30px' }}>
                        <div className="row " >
                            <div className="col-md-7">
                                <div className="row">
                                    ...
                                    <div className="d-flex flex-wrap pt-3">
                                        ...
                                        <Link to="/adveriserauthLogin" className='text-black no-underline hover:no-underline'> <button type="button" className=" SSA_Btn_HOME_buytraffic py-3 px-5 mr-2 p-3">GET TOP TRAFFIC</button></Link>

                                        <Link to="/adveriserauthLogin" className='text-black no-underline hover:no-underline'> <button className=" SSA_Btn_HOME_buytraffic py-3 px-5 mr-2 p-3">
                                            <div className='d-flex'>
                                                <span >LEARN MORE</span>
                                                <span><FaArrowRightLong className='px-1' /></span>
                                            </div>
                                        </button></Link>
                                    </div>
                                </div>
                    ...
                    {socialBar && <><div className="container mt-4 p-5" style={{ backgroundColor: '#efefef', borderRadius: '30px' }}>
                        <div className="row " >
                            <div className="col-md-7">
                                <div className="row">
                                    <div className="col-md-6">
                                    ...
                                    <div className="d-flex pt-3">
                                        <button type="button" class="btn SSA_btn_BenefitsAd_main">TRY SOCIAL BAR</button>
                                        <button type="button" class="btn  px-5 btn-light ml-3"> <div className="d-flex">
                                            LEARN MORE &nbsp; <FaArrowRightLong className='pt-1' /> </div>  </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    {inPagePush && <><div className="container mt-4 p-5" style={{ backgroundColor: '#efefef', borderRadius: '30px' }}>
                        <div className="row " >
                            <div className="col-md-7">
                                <div className="row">
                                    <div className="col-md-6">
                                    ...
                                    <div className="d-flex pt-3">
                                        <button type="button" class="btn SSA_btn_BenefitsAd_main">TRY IN-PAGE PUSH </button>
                                        <button type="button" class="btn  px-5 btn-light ml-3"> <div className="d-flex">
                                            LEARN MORE &nbsp; <FaArrowRightLong className='pt-1' /> </div>  </button>
                                    </div>
                                </div>
